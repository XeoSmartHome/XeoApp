...
export default class DeviceSettingsScreen2 extends Component {
        ...
        API.devices.getDevice({
            ...
            (response) => {
                ...
                this.setState({
                    ...
                    device_default_image: device['default_image'],
                    device_connected: device['connected'],
                    device_last_connection: device['last_connection'],
    ...
    updateDeviceNameCallback(response) {
    ...
    updateDeviceName() {
        API.devices.updateDeviceName({
            id: this.state.device_id,
            name: this.state.new_device_name
        }).then(
            this.updateDeviceNameCallback.bind(this)
        ).catch(
            (error) => {
                console.warn(error);
            }
    ...
    removeDevice() {
        API.devices.removeDevice({
            ...
            this.state.removeDeviceCallback.bind(this)
        ).catch(
            (error) => {
                console.warn(error);
            }
    ...
    updateDeviceImageCallback(response) {
        console.warn(response);
    }

    newUpdateDeviceImage(image) {
        API.devices.updateDeviceImage({
            id: this.state.device_id,
            image: image
        }).then(
            this.updateDeviceImageCallback.bind(this)
        ).catch(
            (error) => {
                console.warn(error);
            }
            ...
            <ScrollView style={[styles.screen, {
                ...
                >
                    ...
                    >
                        ...
                        >
                            You can generate Action links (with or without parameters) directly to a specific intent of
                            your action.
                        </Text>
                    </TouchableOpacity>
                </View>
